...
#for file 4_2C_mbnl_S4_L008_R2_001.fastq.gz
import numpy as np
my_file=open("4_2C_mbnl_S4_L008_R1_001.fastq")
...
whole_read = np.zeros((101,71676772))
...
print("4_2C_mbnl_S4_L008_R1_001.fastq")
...
my_file=open("4_2C_mbnl_S4_L008_R2_001.fastq")
#my_file=open("test_file.txt")
...
#Print our statements
print("4_2C_mbnl_S4_L008_R2_001.fastq")
print("# Base Pair","\t","Mean Quality Score","\t","Variance","\t","Standard Deviation","\t","Median")
for i in range(101):
    print(i,"\t\t",np.mean(whole_read[i,:]),"\t",np.var(whole_read[i,:]),"\t",np.std(whole_read[i,:]),"\t",np.median(whole_read[i,:]))
